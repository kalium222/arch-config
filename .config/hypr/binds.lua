...
local mappings = {
  ...
  -- window resize
  { main .. "+" .. sub .. "+L",         hl.dsp.window.resize { x = 100, y = 0, relative = true, } },
  { main .. "+" .. sub .. "+H",         hl.dsp.window.resize { x = -100, y = 0, relative = true, } },
  { main .. "+" .. sub .. "+K",         hl.dsp.window.resize { x = 0, y = -100, relative = true, } },
  { main .. "+" .. sub .. "+J",         hl.dsp.window.resize { x = 0, y = 100, relative = true, } },
